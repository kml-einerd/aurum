...
async function renderTradingViewWidget() {
    ...
    try {
        ...
        // Copyright removido - não exibir texto do TradingView
        ...
        script.innerHTML = JSON.stringify({
            ...
            "showChart": true,
            "locale": "br",
            "largeChartUrl": "http://localhost:8001/pages/index.html", // Redirect to index.html
            "isTransparent": true,
            "showSymbolLogo": true,
...
function openStockModal(ticker) {
    ...
    // Redirect to index.html with the ticker as parameter
    window.location.href = `http://localhost:8001/pages/index.html?symbol=${cleanTicker}`;
}
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (widgetSymbol) {
        ...
        // Redirect to index.html with the symbol
        const cleanSymbol = widgetSymbol.replace('BMFBOVESPA:', '');
        window.location.href = `http://localhost:8001/pages/index.html?symbol=${cleanSymbol}`;
